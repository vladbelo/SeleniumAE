...
public class RB_Auction_Page {
	...
	private static final String SUBMIT = "//*[@id=\"adv-submit-button\"]";
	@FindBy(xpath = SUBMIT)
	...
	public void submitButton() {
		WebConstants.waitForElementToLoad(driver, SubmitButton, 30);
		System.out.println("Verify Submit Button");
		SubmitButton.click();
		Assert.assertEquals(this.SubmitButton, "Submit Button is not displayed");
	...
	public void verifyListOfExperience() {
		...
		Assert.assertEquals(this.ListResultss.size() > 0, " List is not displayed");
		System.out.println("List of CaterPillare is displayed");
